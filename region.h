...
public:
	...
	void extract_features(cv::Mat& _lab_img, cv::Mat& _grey_img, cv::Mat& _gradient_magnitude, cv::InputArray _fcn_heatmap, cv::Mat& canvas, bool conf[]);
    ...
    float fcn_score_mean_;	///< mean FCN score of region's pixels
};
